...
export default function StocksTable() {
  ...
  const processRowUpdate = (newRow: GridRowModel) => {
    ...
    if (cost != "") {
      if (newRow.status != "Sold") {
        if (newRow.product_type == "WATCH (Old Stock)") {
          // TODO
        } else {
          if (product_type == "BAG") {
          ...
          //   hold_sold_on_date: newRow.hold_sold_on_date,
          //   status: watchStatus(newRow.status),
          ...
          //   cost: cost,
          //   purchase_date: newRow.purchase_date
          // })
          ...
          // console.log('column_s_wholesale_price', newRow.column_s_wholesale_price)
          ...
          if (
            ...
            newRow.extra_300_for_rx_where_wholesale_price_20 = roundValue(
              calculateCAExtra(
                newRow.brand,
          ...
          console.log("newRow.ch24_usd_6", newRow.ch24_usd_6);
        }
      }
